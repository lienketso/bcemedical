                ...
                <div class="col-xl-5 col-lg-6 col-md-8">
                    <div class="footer-contact-info mb-30">
                        ...
                        <div class="footer-emailing">
                            <ul>
                                <li><i class="far fa-envelope"></i><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6f060109002f0a170e021f030a020a0b060c0e03410c0002">[email&#160;protected]</a></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="footer-copyright text-center">
                        <p class="white-color">Copyright <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6b09122b">[email&#160;protected]</a> BasicTheme - 2019</p>
                    </div>
                </div>
            </div>
        </div>
